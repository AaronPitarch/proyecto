 ...
 */
final class Version20221010182740 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE direccion CHANGE cod_postal cod_postal VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE direccion CHANGE cod_postal cod_postal INT NOT NULL');
    }
}
