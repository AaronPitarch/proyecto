 ...
 */
final class Version20220928181500 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE direccion (id INT AUTO_INCREMENT NOT NULL, cliente_id INT NOT NULL, provincia_id INT NOT NULL, municipio_id INT NOT NULL, calle VARCHAR(255) NOT NULL, numero VARCHAR(255) NOT NULL, puerta_piso_escalera VARCHAR(255) NOT NULL, cod_postal INT NOT NULL, INDEX IDX_F384BE95DE734E51 (cliente_id), UNIQUE INDEX UNIQ_F384BE954E7121AF (provincia_id), UNIQUE INDEX UNIQ_F384BE9558BC1BE0 (municipio_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE plato (id INT AUTO_INCREMENT NOT NULL, restaurante_id INT NOT NULL, nombre VARCHAR(255) NOT NULL, descripcion VARCHAR(255) NOT NULL, imagen_url VARCHAR(255) NOT NULL, precio DOUBLE PRECISION NOT NULL, INDEX IDX_914B3E4538B81E49 (restaurante_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
